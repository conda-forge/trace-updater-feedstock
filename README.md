...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/trace-updater-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14985&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/trace-updater-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `trace-updater` can be installed with:

```
conda install trace-updater
```

It is possible to list all of the versions of `trace-updater` available on your platform with:
